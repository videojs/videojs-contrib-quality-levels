...
const builds = [{
  ...
  input: 'src/plugin.js',
  output: {
    name: 'videojsContribQualityLevels',
    file: 'dist/videojs-contrib-quality-levels.js',
    format: 'umd',
    globals: umdGlobals,
    banner
  },
  ...
  input: 'src/plugin.js',
  output: [{
    file: 'dist/videojs-contrib-quality-levels.cjs.js',
    format: 'cjs',
  ...
  input: 'src/plugin.js',
  output: [{
    file: 'dist/videojs-contrib-quality-levels.es.js',
    format: 'es',
    globals: moduleGlobals,
    banner
  }],
  ...
  input: 'test/**/*.test.js',
  output: {
    name: 'videojsContribQualityLevelsTests',
...
if (!isWatch) {
  builds.push({
    ...
    output: {
      name: 'videojsContribQualityLevels',
      file: 'dist/videojs-contrib-quality-levels.min.js',
      format: 'umd',
      globals: umdGlobals,
      banner
    },
